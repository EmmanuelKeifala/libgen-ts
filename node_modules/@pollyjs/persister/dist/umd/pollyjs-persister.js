...
(function (global, factory) {
  ...
  (global = global || self, global['@pollyjs/persister'] = factory());
  ...
  var fastJsonStableStringify = function fastJsonStableStringify(data, opts) {
    ...
    return function stringify(node) {
      ...
      if (_typeof(node) !== 'object') return stringify$1(node);
      var i, out;
      ...
      if (seen.indexOf(node) !== -1) {
        if (cycles) return stringify$1('__cycle__');
  ...
  var Log = /*#__PURE__*/function () {
    ...
    _createClass(Log, [{
      ...
      value: function addEntries() {
        ...
        [].concat(_toConsumableArray(entries), _toConsumableArray(this.entries)), function (a, b) {
  ...
  */
  ...
  function toNVPairs(o) {
    return keys$2(o || {}).reduce(function (pairs, name) {
      var value = o[name];
      ...
      if (isArray$3(value)) {
        ...
        //     => { 'content-type': ['text/htm'] }
        pairs.push.apply(pairs, _toConsumableArray(value.map(function (v) {
          return {
            name: name,
            value: v,
            _fromType: 'array'
  ...
  var Request = function Request(request) {
    ...
    var contentLength = getFirstHeader(request, 'Content-Length');
  ...
  var Response = function Response(response) {
    ...
    var contentLength = getFirstHeader(response, 'Content-Length');
  ...
  var Persister = /*#__PURE__*/function () {
    ...
    _createClass(Persister, [{
      ...
      key: "options",
      get: function get() {
        return _objectSpread(_objectSpread({}, this.defaultOptions || {}), (this.polly.config.persisterOptions || {})[this.constructor.id] || {});
      }
    }, {
      key: "hasPending",
      get: function get() {
      ...
      key: "persist",
      value: function () {
        var _persist = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
          var promises, creator, _iterator, _step, _step$value, recordingId, _step$value$, name, requests, entries, recording, har, _iterator2, _step2, request, entry;
              ...
              switch (_context.prev = _context.next) {
                ...
                case 2:
                  ...
                  creator = {
                    ...
                    comment: "".concat(this.constructor.type, ":").concat(this.constructor.id)
                  };
                  _iterator = _createForOfIteratorHelper(this.pending);
                  _context.prev = 5;
                ...
                case 7:
                  ...
                  _step$value = _slicedToArray(_step.value, 2), recordingId = _step$value[0], _step$value$ = _step$value[1], name = _step$value$.name, requests = _step$value$.requests;
                  entries = [];
                  _context.next = 12;
                  return this.findRecording(recordingId);
                ...
                case 18:
                  ...
                  this.assert("Cannot persist response for [".concat(entry.request.method, "] ").concat(entry.request.url, " because the status code was ").concat(entry.response.status, " and `recordFailedRequests` is `false`"), entry.response.status < 400 || request.config.recordFailedRequests);
                  /*
          ...
          }, _callee, this, [[5, 43, 46, 49], [16, 29, 32, 35]]);
        }));
      ...
      key: "findRecording",
      value: function () {
        var _findRecording = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(recordingId) {
          var _this = this;

          var cache, onFindRecording;
              ...
              switch (_context3.prev = _context3.next) {
                case 0:
                  ...
                  if (!cache.has(recordingId)) {
                    onFindRecording = /*#__PURE__*/function () {
                        ...
                        return regenerator.wrap(function _callee2$(_context2) {
                          while (1) {
                            switch (_context2.prev = _context2.next) {
                              case 0:
                                _context2.next = 2;
                                return _this.onFindRecording(recordingId);
                      ...
                      return function onFindRecording() {
        ...
        function findRecording(_x) {
          return _findRecording.apply(this, arguments);
        }
      ...
      key: "onFindRecording",
      value: function onFindRecording() {
        this.assert('Must implement the `onFindRecording` hook.');
      }
    }, {
      key: "saveRecording",
      value: function () {
        var _saveRecording = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4(recordingId, har) {
          ...
          return regenerator.wrap(function _callee4$(_context4) {
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  _context4.next = 2;
                  return this.onSaveRecording.apply(this, _args4);
        ...
        function saveRecording(_x2, _x3) {
      ...
      key: "onSaveRecording",
      value: function onSaveRecording() {
        this.assert('Must implement the `onSaveRecording` hook.');
      }
    }, {
      key: "deleteRecording",
      value: function () {
        var _deleteRecording = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee5(recordingId) {
          ...
          return regenerator.wrap(function _callee5$(_context5) {
            while (1) {
              switch (_context5.prev = _context5.next) {
                case 0:
                  _context5.next = 2;
                  return this.onDeleteRecording.apply(this, _args5);
      ...
      key: "onDeleteRecording",
      value: function onDeleteRecording() {
        this.assert('Must implement the `onDeleteRecording` hook.');
      }
    }, {
      key: "findEntry",
      value: function () {
        var _findEntry = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee6(pollyRequest) {
