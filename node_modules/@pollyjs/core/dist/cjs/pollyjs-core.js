...
var logLevel = _interopDefault(require('loglevel'));
...
class Logger {
  ...
  logRequest(request) {
    ...
    log.info(`Request: ${request.method} ${request.url}`, ...(debug ? [{
      request
    }] : []));
  }
  ...
  logRequestResponse(request, response) {
    ...
    const debug = log.getLevel() <= log.levels.DEBUG;
    log.info(`Response: ${FORMATTED_ACTIONS[request.action]} ➞ ${request.method} ${request.url} ${response.statusCode} • ${request.responseTime}ms`, ...(debug ? [{
      request,
      response
    }] : []));
  }
  ...
  logRequestError(request, error) {
    ...
    const debug = log.getLevel() <= log.levels.DEBUG;
    log.error(`Errored ➞ ${request.method} ${request.url}`, error, ...(debug ? [{
      request
    }] : []));
  }
...
function ownKeys(object, enumerableOnly) { var keys = keys$3(object); if (getOwnPropertySymbols$1) { var symbols = getOwnPropertySymbols$1(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return getOwnPropertyDescriptor$1(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (getOwnPropertyDescriptors$1) { defineProperties$1(target, getOwnPropertyDescriptors$1(source)); } else { ownKeys(Object(source)).forEach(function (key) { defineProperty$3(target, key, getOwnPropertyDescriptor$1(source, key)); }); } } return target; }
...
class EventEmitter {
  ...
  once(eventName, listener, options = {}) {
    this.on(eventName, listener, _objectSpread(_objectSpread({}, options), {}, {
      times: 1
    }));
    return this;
  }
...
class PollyRequest extends HTTPBase {
  ...
  get log() {
    if (this.id) {
      const log = logLevel.getLogger(`@pollyjs/core:${this.recordingName}:${this.id}`);
...
function ownKeys$1(object, enumerableOnly) { var keys = keys$3(object); if (getOwnPropertySymbols$1) { var symbols = getOwnPropertySymbols$1(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return getOwnPropertyDescriptor$1(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

function _objectSpread$1(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$1(Object(source), true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (getOwnPropertyDescriptors$1) { defineProperties$1(target, getOwnPropertyDescriptors$1(source)); } else { ownKeys$1(Object(source)).forEach(function (key) { defineProperty$3(target, key, getOwnPropertyDescriptor$1(source, key)); }); } } return target; }
...
class Route {
  ...
  constructor(recognizeResults, middleware) {
    ...
    if (result) {
      ...
      this.params = _objectSpread$1({}, result.params);
...
function ownKeys$2(object, enumerableOnly) { var keys = keys$3(object); if (getOwnPropertySymbols$1) { var symbols = getOwnPropertySymbols$1(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return getOwnPropertyDescriptor$1(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
...
class Handler extends map$1 {
  ...
  on(eventName, listener, options = {}) {
    this._eventEmitter.on(eventName, listener, _objectSpread$2(_objectSpread$2({}, this.get('defaultOptions')), options));
  ...
  intercept(fn, options = {}) {
    ...
    options = _objectSpread$2(_objectSpread$2({}, this.get('defaultOptions')), options);
